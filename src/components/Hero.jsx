        ...
        >
          <div
            className="relative z-1 p-0.5 rounded-2xl
                    bg-conic-gradient"
          >
            <div className="relative bg-n-8 rounded-2xl[1rem">
              <div />
              <div
              ...
              >
                <img
                  src={robot}
                  className="w-full width={1024} scale-[1.7] translate-y-[8%] md:scale-[1] md:-translate-y-[10%] lg:-translate-y[23%]"
                  width={1024}
                  height={490}
                  alt="AI"
                />
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <ul
                    className="hidden absolute -left-[5.5rem]
                                bottom-[7.5rem] px-1 py-1 bg-n-9/40 backdrop-blur border border-n-1/10 rounded-2xl xl:flex"
                  >
