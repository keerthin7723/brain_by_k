    ...
    return (
        ...
        lg:backdrop-blur-sm ${openNavigation ?
            ...
            xl:px-10 max-lg:py-4">
                <a className="block w-[12cm] xl:mr-8"
                    href="#hero">
                    ...
                    <div className="relative z-2 flex flex-col items-center justify-center m-auto lg:flex-row">
                        {navigation.map((item) => (
                            <a
                                ...
                                href={item.url}
                                onClick={handleClick}
                                className={`block relative font-code text-2xl uppercase text-n-1 transition-colors hover:text-color-1 px-6 py-6 md:py-8 lg:mr-0.25 lg:text-xs lg:font-semibold lg:leading-5 lg:hover:text-n-1 xl:px-12 ${item.onlyMobile ? "lg:hidden" : ""
                ...
                <a
                    href="#signup" className="button hidden mr-8 text-n-1/50
