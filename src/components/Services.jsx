      ...
      <div className="container">
        ...
        <div className="relative">
          ...
          >
            ...
            <Generating
              className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 left-right-auto lg:bottom-8 lg:-translate-x-1/2"
            />
          </div>
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[45rem]">
              <div className="py-12 px-4 xl:px-8">
                ...
                <ul className="flex items-center justify-between">
                  {brainwaveServicesIcons.map((item, index) => (
                    ...
                    >
                      <div 
                      className={index === 2 ? 'flex item-center justify-center w-full h-full bg-n-7 rounded-[1rem]':""}>
                        <img src={item} 
                        width={24}
                        height={24}
                        alt={item}/>
              ...
              <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                <img 
                src={service3} className="w-full object-cover"
                width={520}
                height={400}
                alt="Scary robot"/>
                <VideoChatMessage />
